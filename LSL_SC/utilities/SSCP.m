...
[D,cofficents]=dlsc(patch1,par.ncol,patch1);
%===================feature selection======================================
[patch_row1,patch_col1]=size(patch1);
feature_variance=featureselection_supervised(par.ncol,patch_col1,cofficents, D,Class_Train_NUM,Class_NUM,Train_NUM,patch_row1*patch_number);
% ================================decomposition============================
...
% ================================learn the matrix==========================
[Projection_Matrix] =learnmatrixpsupervised(Train_DAT_1,Train_DAT_2,Train_NUM,Namana,Class_NUM,NN,Eigen_NUM,Disc_NUM);
